    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white fixed-top">
        <div class="container-fluid">
            <a href="<?= base_url(''); ?>" class="navbar-brand">
                <img src="<?= base_url(''); ?>/assets/backend/img/title/logotitle.png" alt="AdminLTE Logo" class="brand-image">
            </a>
            ...
            <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    $uri = $db->table('auth_groups_permissions')
                        ->join('auth_permissions', 'auth_permissions.id=auth_groups_permissions.permission_id', 'left')
                        ->where('auth_permissions.name', $menuaktif)
                        ->where('auth_groups_permissions.group_id', $role)->get()->getRowArray();
                    ...
                    if ($uri == null) {
                        ...
                        $urisegment = $uri['parent_id'];
                    }
                    ?>
                    <?php foreach ($menu as $m) : ?>
                        <li <?php if ($urisegment == $m['id']) {
            ...
            <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                ...
                <li class="nav-item dropdown user user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="/assets/backend/dist/img/avatar5.png" class="user-image img-circle elevation-2 alt=" User Image">
                        <span class="hidden-xs"><?= user()->username; ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li class="user-header bg-white">
                            <img src="/assets/backend/dist/img/avatar5.png" class="img-circle elevation-2" alt="User Image">
                            <p>
                                <?= user()->username; ?>
